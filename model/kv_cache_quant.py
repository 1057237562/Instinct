...
_FP8_TYPES = {"fp8_e4m3": torch.float8_e4m3fn, "fp8_e5m2": torch.float8_e5m2}

_CAST_TYPES = {"fp32": torch.float32, "bf16": torch.bfloat16, "fp16": torch.float16}


def is_fp8(dtype_str):
    return dtype_str in _FP8_TYPES


def quantize_kv(x, dtype_str):
    ...
    if dtype_str in _FP8_TYPES:
        ...
        max_pos = torch.finfo(dt).max  # e4m3: 448, e5m2: 57344
